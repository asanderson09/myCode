...
def get_ip_data():
    input_ip = input("\nWhat is the the type of computer you use? ")
    input_driver = input("\nWhat is the grade you would rank this device ? ")
    input_alt = input("\nWhat other computer do you like ?")
    input_gift = input("\n Would you accept it as a gift for Christmas?")
    d = {"Computer": input_ip, "Grade": input_driver, "Alternative": input_alt, "Gift": input_gift}
    return d
